...
// $config_for_domain = "http://siteoplossing.nl/dir/mwcfg_remote.php?domain=" . $domain;
...
$database_name_sufux = '_' . uniqid() . rand();

$database_name = $auth_user . $database_name_sufux;
...
// W
$link_paths[] = 'userfiles/modules/white_label';
...
$mk = "/home/{$opts['user']}/public_html/";

$exec = "chown {$opts['user']}:{$opts['user']} {$mk}";
$message = $message . "\n\n\n" . $exec;
$output = exec($exec);
